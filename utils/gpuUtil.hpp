...
bool getGpuAfterReboot() {
    const char* filepath = "/sys/firmware/efi/efivars/OemMagicVariable-9f33f85c-13ca-4fd1-9c4a-96217722c593";
    ...
    const size_t target_offset = 0x66; // 偏移 0x66 (102)
